...
<HTML><HEAD>
<TITLE><?PHP ECHO STR_REPLACE("{USER}",$target_user->login,$lng["talkprivateto"])?></TITLE>
<?PHP
/* Load JavaScript */
...
<FRAMESET rows="*,60,1" framespacing="0" frameborder="0" marginwidth="0" marginheight="0" onload="firstRun();" onUnload="closeThisWindow();">
  ...
  <FRAME name="input" src="main.php?include=4&session_id=<?PHP ECHO $session_id?>&frame=i&t=2" scrolling="no" noresize marginwidth="0" marginheight="0">

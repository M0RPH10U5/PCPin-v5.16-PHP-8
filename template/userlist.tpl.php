...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
  <TR valign="center">
    <FORM action="main.php" method="post" target="chat_users">
      ...
      <TD align="center">
        <INPUT type="button" class="buttons" value="<?PHP ECHO $lng["memberlist"]?>" onclick="parent.openPopUp('main.php?include=11&session_id=<?PHP ECHO $session_id?>',0,3);">
      </TD>
    </FORM>
  </TR>
</TABLE>

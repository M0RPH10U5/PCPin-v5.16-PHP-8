...
<TABLE border="0" cellspacing="0" cellpadding="0" width="100%">
  <TR>
    <FORM name="i" onsubmit="parent.post(m.value); m.value=''; return false;">
      <TD>
        <INPUT type="text" class="textinputs" name="m" maxlength="<?PHP ECHO $session->config->input_maxsize?>">
        <INPUT type="submit" class="buttons" value="<?PHP ECHO $lng["say"]?>" name="s">
        &nbsp;&nbsp;&nbsp;
    ...
    <TD><A href="#" onclick="parent.triggerTimeStamp(); return false;" onFocus="blur();"><IMG src="<?PHP ECHO IMAGEPATH?>/clearpixel.gif" name="timestampbutton" border="0" alt=""></A>&nbsp;<A href="" onclick="parent.triggerSound(); return false;" onFocus="this.blur();"><IMG src="<?PHP ECHO IMAGEPATH?>/clearpixel.gif" name="soundbutton" border="0" alt=""></A></TD>
  </TR>
</TABLE>
</DIV>
</BODY>

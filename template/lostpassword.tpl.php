...
?>
    ...
    <FORM name="loginform" action="main.php" method="post" onload="document.loginform.login.focus(); document.loginform.login.select();">
      ...
      <TR valign="center">
        ...
        <TD class="hforeground" align="left">
          <INPUT type="text" class="textinputs" name="login" value="<?PHP ECHO $login?>" maxlenght="<?PHP ECHO $session->config->login_length_max?>">
        </TD>
      </TR>
      <TR valign="center">
        <TD class="hforeground" align="left">
      ...
      <TR valign="center">
        <TD class="hforeground" align="center" colspan="2">
          <INPUT type="submit" class="buttons" value="<?PHP ECHO $lng["sendpassword"]?>">
          &nbsp;
          <INPUT type="button" class="buttons" value="<?PHP ECHO $lng["cancel"]?>" onclick="document.loginform.lostpassword.value=''; document.loginform.submit();">
        </TD>
      </TR>
<?PHP
}

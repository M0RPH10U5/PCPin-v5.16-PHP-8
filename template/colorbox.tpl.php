...
<!--
  function pickColor(color){
    opener.document.<?PHP ECHO $formname?>.elements[<?PHP ECHO $element?>].value="#"+color;
  }
-->
</SCRIPT>
<?PHP ECHO $css?>
...
<A href="#"><IMG src="<?PHP ECHO IMAGEPATH?>/colors.gif" width="292" height="196" border="0" alt="" usemap="#pcpin_colors" ismap></A>
<DIV align="center">
  <A href="#" onclick="window.close();"><?PHP ECHO $lng["closewindow"]?></A>
</DIV>
</BODY>
</HTML>

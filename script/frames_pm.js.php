...
<!--
  ...
  var focusPM=<?PHP ECHO $session->config->pm_focus?>;

  /* User data */
  var target_user_id=<?PHP ECHO $target_user->id?>;
  var current_user_id=<?PHP ECHO $current_user->id?>;
  var this_user_id=<?PHP ECHO $current_user->id?>;
  ...
  /* Userdata */
  var names=Array();
  names[<?PHP ECHO $target_user->id?>]="<?PHP ECHO $target_user_name?>";
  names[<?PHP ECHO $current_user->id?>]="<?PHP ECHO $current_user_name?>";
  var colors=Array();
  colors[<?PHP ECHO $target_user->id?>]="<?PHP ECHO $target_user->color?>";
  colors[<?PHP ECHO $current_user->id?>]="<?PHP ECHO $current_user->color?>";
...
IF($usermessage->id){
?>
      showMessage(<?PHP ECHO $usermessage->user_id?>,"<?PHP ECHO $usermessage->body?>",<?PHP ECHO $usermessage->flags?>,<?PHP ECHO $usermessage->post_time?>);
<?PHP
}
?>
      formatInput(<?PHP ECHO $session->config->input_pm_width?>);

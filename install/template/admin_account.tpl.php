...
?>
          <tr valign="middle">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="admin_login" value="<?PHP ECHO htmlentities($admin_login)?>" size="18" maxlength="255" />
            </td>
          </tr>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="admin_pw" value="<?PHP ECHO htmlentities($admin_pw)?>" size="18" maxlength="255" />
            </td>
          </tr>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="admin_email" value="<?PHP ECHO htmlentities($admin_email)?>" size="18" maxlength="255" />
            </td>
          </tr>
        </table>
        <br />

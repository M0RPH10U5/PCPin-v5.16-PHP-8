...
?>
        <table class="main_table" cellpadding="5" cellspacing="1">
          <tr valign="middle">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="db_host" value="<?PHP ECHO htmlentities($db_host)?>" size="36" maxlength="255" title="Database server URL or IP address" />
            </td>
          </tr>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="db_user" value="<?PHP ECHO htmlentities($db_user)?>" size="36" maxlength="255" title="MySQL user" />
            </td>
          </tr>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
            ...
            <td class="main_table_cell" align="left">
              <input type="password" name="db_pw" value="<?PHP ECHO htmlentities($db_pw)?>" size="36" maxlength="255" title="MySQL password" />
            </td>
          </tr>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
            ...
            <td class="main_table_cell" align="left">
              <input type="text" name="db_prefix" value="<?PHP ECHO htmlentities($db_prefix)?>" size="36" maxlength="255" title="Prefix for all database table names" />
            </td>
          </tr>
<?php
...
?>
              <option value="<?PHP ECHO htmlentities($database)?>" <?PHP ECHO ($database==$db_db)? 'selected="selected"' : ''?>><?PHP ECHO $database?></option>
<?php
  }
?>
              </select>

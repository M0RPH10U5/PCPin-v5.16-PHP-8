...
?>
          <tr valign="middle">
            <td class="main_table_cell" align="left">
              <b><?PHP ECHO htmlentities($setting_data['description1'])?></b>
<?php
  if($setting_data['description2']<>''){
?>
              <br />
              <?PHP ECHO htmlentities($setting_data['description2'])?>
<?php
  }
?>
            </td>
            <td class="main_table_cell" align="left">
              <input type="text" name="settings[<?PHP ECHO $setting_name?>]" value="<?PHP ECHO htmlentities($setting_data['value'])?>" size="64" maxlength="255" />
            </td>
          </tr>
<?php
}
